...
class EntityTestState: public our::State {
    ...
    void onDraw(double deltaTime) override {
        ...
        glm::mat4 PV = camera->getProjectionMatrix(getApp()->getFrameBufferSize()) * camera->getViewMatrix();
        ...
        for(auto& entity : world.getEntities()){
            ...
            // Get model matrix and compute MVP
            glm::mat4 M = entity->getLocalToWorldMatrix();
            
            // Setup material and draw mesh
            meshRenderer->material->setup();
            meshRenderer->material->shader->set("transform", PV * M);
